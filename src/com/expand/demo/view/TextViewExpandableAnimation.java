...
public class TextViewExpandableAnimation extends LinearLayout implements
	...
	/**
	 * 改变折叠状态（仅仅改变折叠与展开状态，不会隐藏折叠/展开图片布局） change shrink/expand state(only change
	...
	/**
	 * 设置折叠状态（如果折叠行数设定大于文本行数，那么折叠/展开图片布局将会隐藏,文本将一直处于展开状态） change shrink/expand
